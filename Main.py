...
def addSupplies1(Supplies):
    ...
    print("Added " + Supplies.getName + " to Supplies List for Supplier 1")

def addSupplies2(Supplies):
    SuppliesList2.append(Supplies)
    print("Added " + Supplies.getName + " to Supplies List for Supplier 2")

def addSupplies3(Supplies):
    SuppliesList3.append(Supplies)
    print("Added " + Supplies.getName + " to Supplies List for Supplier 3")
...
tenderloin = Supplies('Beef Tenderloin', 44.99)
